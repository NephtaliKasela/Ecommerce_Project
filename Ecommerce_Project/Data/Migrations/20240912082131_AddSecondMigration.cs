        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StoreContactInfo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    StoreFacebookUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StoreTwitterUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StoreInstagramUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StoreShippingPolicy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StoreReturnPolicy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StoreFeatured = table.Column<bool>(type: "bit", nullable: false),
                    StoreActive = table.Column<bool>(type: "bit", nullable: false),
                    StoreCreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StoreUpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CountryId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductPrices_Products_BodyProductId",
                        column: x => x.BodyProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
